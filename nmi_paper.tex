...
density. Finally, on a \emph{real} signal --- the 277-year SILSO sunspot record, a
benchmark no part of the pipeline generated --- the same frozen weak-form identifier
generalizes to unseen decades at \textbf{${\sim}500\times$ lower holdout error than
finite-difference identification} ($1.9{\times}10^{-5}$ vs.\ $9.1{\times}10^{-3}$,
signal-normalized), stays flat under 50\% added measurement noise, and beats
persistence at one-month forecasts while using ${\sim}10\times$ less memory than a
reservoir. The angles are computation; the shape is the interpretable spectrum.
\end{abstract}
...
(400 neurons, ridge readout), and persistence.
...
The honest boundary: nonlinear learners that fit the \emph{level} directly ---
AR(24) and the ESN --- are better at long horizons ($0.18$ and $0.17$ vs.\
$0.30$ at 12 months), because a derivative law carries almost no level
information, and the sunspot cycle's amplitude and period drift across decades.
A derivative-law identifier is not a long-horizon forecaster; it is a robust
law extractor, and that is the claim Table~6 supports.
...
(free level fit) lead at long horizons. ESN: mean $\pm$ s.d. over three
reservoir seeds.}
\begin{tabular}{lccccccc}
\toprule
horizon & weak & FD stream & batch weak & batch FD & AR(24) & ESN & persist. \\
\midrule
1 mo & $0.116$ & $0.260$ & $0.117$ & $0.187$ & $0.095$ & $0.096{\pm}0.002$ & $0.119$ \\
6 mo & $0.197$ & $0.627$ & $0.204$ & $0.309$ & $0.135$ & $0.133{\pm}0.006$ & $0.193$ \\
12 mo & $0.296$ & $1.310$ & $0.310$ & $0.527$ & $0.177$ & $0.166{\pm}0.010$ & $0.284$ \\
24 mo & $0.607$ & $5.449$ & $0.628$ & $1.561$ & $0.282$ & $0.251{\pm}0.021$ & $0.578$ \\
\bottomrule
\end{tabular}
\end{table}
...
streaming batch solvers would close part of the gap --- but as Sec.~2.2 shows, making
the batch estimator streaming does not close the \emph{error} gap, which is the
substantive claim.
...
(8-seed $\times$ 6-variant ablation), and \texttt{scaling.json} (5-seed $\times$
3 grid sizes). The manuscript's numbers are read directly from these files.
